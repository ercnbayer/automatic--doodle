...
func ExpiredAt(v time.Time) predicate.RefreshToken {
...
func HasUsers() predicate.RefreshToken {
...
func HasUsersWith(preds ...predicate.User) predicate.RefreshToken {
	return predicate.RefreshToken(func(s *sql.Selector) {
		step := newUsersStep()
