...
func (rtq *RefreshTokenQuery) QueryUsers() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, refreshtoken.UsersTable, refreshtoken.UsersColumn),
		)
...
func (rtq *RefreshTokenQuery) WithUsers(opts ...func(*UserQuery)) *RefreshTokenQuery {
	query := (&UserClient{config: rtq.config}).Query()
...
func (rtq *RefreshTokenQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*RefreshToken, error) {
	...
	if query := rtq.withUsers; query != nil {
		if err := rtq.loadUsers(ctx, query, nodes, nil,
			func(n *RefreshToken, e *User) { n.Edges.Users = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (rtq *RefreshTokenQuery) loadUsers(ctx context.Context, query *UserQuery, nodes []*RefreshToken, init func(*RefreshToken), assign func(*RefreshToken, *User)) error {
