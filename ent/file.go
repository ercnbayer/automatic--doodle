...
type File struct {
	...
	// Extention holds the value of the "extention" field.
...
func (*File) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case file.FieldFilename, file.FieldExtention, file.FieldType, file.FieldBucket, file.FieldContentType:
			values[i] = new(sql.NullString)
		case file.FieldCreatedAt, file.FieldUpdatedAt:
			values[i] = new(sql.NullTime)
		case file.FieldID, file.FieldCreatedByID:
...
func (f *File) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case file.FieldExtention:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field extention", values[i])
			} else if value.Valid {
				f.Extention = value.String
			}
...
func (f *File) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("extention=")
	builder.WriteString(f.Extention)
	builder.WriteString(", ")
	builder.WriteString("created_by_id=")
	builder.WriteString(fmt.Sprintf("%v", f.CreatedByID))
	builder.WriteString(", ")
